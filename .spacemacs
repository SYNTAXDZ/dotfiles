  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-directory "~/Base/Knowledge/org/"
...
(defun my-setup-indent (n)
  ...
  (setq rust-tab-width n) ; coffeescript
  ;; (setq csharp-indent-level n) ; javascript-mode
  )
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (my-setup-indent 4) ; indent 4 spaces
  ;; terminal-here-terminal-command (list "my-terminal" "--foo")
...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((setq helm-ctest-build-dir "~/Base/Knowledge/learn_cpp/CppProjects/learn_vulkan/build")
     ...
     (cmake-ide-project-dir . "~/Base/Knowledge/learn_cpp/CppProjects/FirstGameEngine")
