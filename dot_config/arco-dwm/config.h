...
static const char col_cyan[]        = "#282840";
...
static const Rule rules[] = {
	...
	{ "Arcolinux Logout",         NULL,       NULL,       7,            1,           -1 },
};
...
static const char *roficmd[] = { "rofi", "-show", "drun", "-font", "hack 12", "show", "combi", "-icon-theme", "Papirus", "-show-icons" };
